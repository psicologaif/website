...
export class BrochureComponent implements OnInit {
  ...
  pages: BrochurePage[] = [
    ...
    },
    {
      ...
      description:
        "Progetto realizzato dall'Istituto Comprensivo R. Levi Montalcini di Civitella - Torricella di mentoring ed orientamento per gli alunni iscritti alla scuola. L'obiettivo è stato quello di sviluppare una maggiore autostima e fiducia, gestire lo stress e le emozioni, identificare punti di forza ed interessi e sviluppare abilità sociali e di comunicazione. Il mio ruolo è stato quello di supportare alcuni bambini/e per migliorare il loro adattamento scolastico, eliminare fenomeni di bullismo, identificare attività di motivazione allo studio e insegnare a gestire le emozioni negative in modo sano e costruttivo. In foto, l'esercizio \"zaino delle competenenze\" che aiuta a riconoscere e valorizzare le proprie qualità e competenze ed a vedersi in modo completo, senza etichette.",
    },
  ];
  ...
  truncateDescription(text: string, limit: number = 300): string {
    if (!text) return '';
